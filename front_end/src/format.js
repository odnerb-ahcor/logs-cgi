...
var shift = createShiftArr('    ')

const sqlFormat =  function(text) {
  var ar_by_quote = text.replace(/\s{1,}/g," ")
    ...
    str = str.replace(/^\n{1,}/,'').replace(/\n{1,}/g,"\n");
   // $('#xml_text').html(str)
    //console.log('teste: '+$('.oxe > p').text())
    return {line: linhas(str), sql: str};
}

const xmlFormat = function(text) {
  ...
  //$('#xml_texts').html((str[0] == '\n') ? str.slice(1) : str)
  str = (str[0] == '\n') ? str.slice(1) : str
  return {line: linhas(str), xml: str};
  //return (str[0] == '\n') ? str.slice(1) : str
}
